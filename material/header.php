...
<head>
	...
	<link rel="stylesheet" href="<?php $this->options->themeUrl('material.css'); ?>">
	<link rel="stylesheet" href="<?php $this->options->themeUrl('prettify.css'); ?>">
...
<![endif]-->
	...
	<div class="header-background">
		<div id="triangles-1" class="triangles"></div>
		<div id="triangles-2" class="triangles"></div>
		<div id="triangles-3" class="triangles"></div>
...
<?php } ?>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-mb-12">
                <ul id="nav-menu" class="col-5" role="navigation">
                    <li<?php if($this->is('index')): ?> class="current"<?php endif; ?>><a href="<?php $this->options->siteUrl(); ?>"><?php _e('首页'); ?></a></li>
					<li<?php if($this->is('archive') && !$this->is('index')): ?> class="current"<?php endif; ?>><a class="drop-btn" href="<?php $this->options->siteUrl(); ?>index.php/blog/"><?php _e('文章分类'); ?></a>
					<ul class="drop-list">
